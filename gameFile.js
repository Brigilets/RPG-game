...
function fillArena(){
   // console.log(race2.value);
    ...
    /*alert(race1.options[race1.selectedIndex].value);
    alert(race2.options[race2.selectedIndex].value);
    alert(race1.options[race1.selectedIndex].text);
    alert(race2.options[race2.selectedIndex].text);*/
}
